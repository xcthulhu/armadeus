...
CH7024CTRL_VER:=1.0
CH7024CTRL_SOURCE:=$(BUILD_DIR)/../../target/packages/ch7024ctrl
CH7024CTRL_DIR:=$(BUILD_DIR)/ch7024ctrl-$(CH7024CTRL_VER)
CH7024CTRL_CAT:=zcat
CH7024CTRL_BINARY:=ch7024
CH7024CTRL_TARGET_BINARY:=usr/bin/ch7024
...
$(TARGET_DIR)/$(CH7024CTRL_TARGET_BINARY): $(CH7024CTRL_DIR)/$(CH7024CTRL_BINARY)
	install -D $< $@
	$(STRIP) $(TARGET_DIR)/$(CH7024CTRL_TARGET_BINARY)

ch7024ctrl: uclibc $(TARGET_DIR)/$(CH7024CTRL_TARGET_BINARY)
