...
MAX5821CTRL_VER:=1.0
MAX5821CTRL_SOURCE:=$(TOPDIR)/../target/packages/max5821ctrl
...
$(TARGET_DIR)/$(MAX5821CTRL_TARGET_BINARY): $(MAX5821CTRL_DIR)/$(MAX5821CTRL_BINARY)
	install -D $< $@
	$(STRIPCMD) $(STRIP_STRIP_UNNEEDED) $(TARGET_DIR)/$(MAX5821CTRL_TARGET_BINARY)

max5821ctrl: $(TARGET_DIR)/$(MAX5821CTRL_TARGET_BINARY)
