...
#define CONFIG_SYS_HZ			1000l	/* incrementer freq: 1 MHz   */
...
/* micron 8MB */
#define CONFIG_SYS_SDRAM_1_BASE	0x08000000 /* SDRAM bank #1 32bits         */
...
#define CONFIG_SYS_SDRAM_REFRESH		2  /* 0=OFF 1=2048 2=4096 3=8192 refresh */
#define CONFIG_SYS_SDRAM_CLOCK_CYCLE_CL_1	20 /* ns clock cycle time when CL=1 */
#define CONFIG_SYS_SDRAM_ROW_PRECHARGE_DELAY	20 /* ns SRP */
#define CONFIG_SYS_SDRAM_ROW_2_COL_DELAY	20 /* ns SRCD */
#define CONFIG_SYS_SDRAM_ROW_CYCLE_DELAY	70 /* ns SRC */
...
#define CONFIG_SYS_TFTP_LOADADDR	0x08000000
/*
 * Hardware drivers
 */
...
#define CONFIG_FPGA		0x801		/* CONFIG_SYS_XILINX_SPARTAN3 */
#define CONFIG_FPGA_XILINX
#define CONFIG_FPGA_SPARTAN3
#define CONFIG_SYS_FPGA_WAIT		250
#define CONFIG_SYS_FPGA_PROG_FEEDBACK
#define CONFIG_SYS_FPGA_CHECK_CTRLC
#define CONFIG_SYS_FPGA_CHECK_ERROR

/* FPGA program pin configuration */
#define CONFIG_SYS_FPGA_PRG	(GPIO_PORTB | 18)	/* FPGA prog pin (SSI output) */
#define CONFIG_SYS_FPGA_CLK	(GPIO_PORTB | 19)	/* FPGA clk pin  (SSI output) */
#define CONFIG_SYS_FPGA_DATA	(GPIO_PORTB | 17)	/* FPGA data pin (SSI output) */
#define CONFIG_SYS_FPGA_INIT	(GPIO_PORTB | 15)	/* FPGA init pin (SSI input)  */
#define CONFIG_SYS_FPGA_DONE	(GPIO_PORTB | 16)	/* FPGA done pin (SSI input)  */
...
#define CONFIG_SYS_CS0_CHIP_SELECT_ENABLE	1	/* 1 : enable CS0 peripherals */
#define CONFIG_SYS_CS0_DATA_PORT_SIZE		0x5	/* 5=16 bits on D[15:0] pins  */
						/* 3=8bits on D[7:0] 6=32 bits..*/
#define CONFIG_SYS_CS0_SUPERVISOR_PROTECT	0   /* 1 : user mode access prohibited  */
#define CONFIG_SYS_CS0_WRITE_PROTECT		0   /* 1 : write access prohibited  */
#define CONFIG_SYS_CS0_EB_SIGNAL_CONTROL_WRITE	1   /* 1 when EB is used as write signal */
...
#define CONFIG_SYS_CS0_XTRA_DEAD_CYC	35	/* ns from CS HIGH to tristate bus */
...
#define CONFIG_SYS_CS0_SYNC_ENABLE		1	/* enable synchronous burst mode */
#define CONFIG_SYS_CS0_SYNC_PAGE_MODE_EMUL	1	/* enable page mode emulation */
#define CONFIG_SYS_CS0_SYNC_PAGE_SIZE		0	/* 4 words page size (8bytes) */
...
#define CONFIG_SYS_CS1_CHIP_SELECT_ENABLE	1	/* 1 : enable CS0 peripherals  */
#define CONFIG_SYS_CS1_PIN_ASSERT		0	/* chip select pin state when */
						/* chip select disabled  */
#define CONFIG_SYS_CS1_DATA_PORT_SIZE		0x5	/* 5=16 bits on D[15:0] pins*/
						/* 3=8bits on D[7:0] 6=32 bits..*/ 
#define CONFIG_SYS_CS1_SUPERVISOR_PROTECT	0	/* 1 : user mode access prohibited  */
#define CONFIG_SYS_CS1_WRITE_PROTECT		0	/* 1 : write access prohibited  */
#define CONFIG_SYS_CS1_EB_SIGNAL_CONTROL_WRITE	1	/* 1 when EB is used as write signal */

#define CONFIG_SYS_CS1_READ_CYC_LGTH		50	/* ns */
#define CONFIG_SYS_CS1_OE_ASSERT_DLY		0	/* ns */
#define CONFIG_SYS_CS1_OE_NEG_DLY		0	/* ns */

#define CONFIG_SYS_CS1_CS_NEG_LGTH 	0	/* max 30 ns CS HIGH to CS LOW at 100MHz */
#define CONFIG_SYS_CS1_XTRA_DEAD_CYC	0	/* ns from CS HIGH to tristate bus */
...
#define CONFIG_SYS_CS1_SYNC_ENABLE		0	/* enable synchronous burst mode */
#define CONFIG_SYS_CS1_SYNC_PAGE_MODE_EMUL	0	/* enable page mode emulation */
#define CONFIG_SYS_CS1_SYNC_PAGE_SIZE		0	/* 4 words page size (8bytes) */
...
#define CONFIG_SYS_CS2_CHIP_SELECT_ENABLE	0	/* 1 : enable CS0 peripherals  */
#define CONFIG_SYS_CS2_PIN_ASSERT		0	/* chip select pin state when */
						/*chip select disabled  */
#define CONFIG_SYS_CS2_DATA_PORT_SIZE		0x5	/* 5=16 bits on D[15:0] pins */
						/* 3=8bits on D[7:0] 6=32 bits..*/
#define CONFIG_SYS_CS2_SUPERVISOR_PROTECT	0	/* 1 : user mode access prohibited  */
#define CONFIG_SYS_CS2_WRITE_PROTECT		0	/* 1 : write access prohibited  */
#define CONFIG_SYS_CS2_EB_SIGNAL_CONTROL_WRITE	1	/* 1 when EB is used as write signal */

#define CONFIG_SYS_CS2_READ_CYC_LGTH		0	/* ns */
#define CONFIG_SYS_CS2_OE_ASSERT_DLY		0	/* ns */
#define CONFIG_SYS_CS2_OE_NEG_DLY		0	/* ns */

#define CONFIG_SYS_CS2_CS_NEG_LGTH 	0	/* max 30 ns CS HIGH to CS LOW at 100MHz */
#define CONFIG_SYS_CS2_XTRA_DEAD_CYC	0	/* ns from CS HIGH to tristate bus */
...
#define CONFIG_SYS_CS2_SYNC_ENABLE		0	/* enable synchronous burst mode */
#define CONFIG_SYS_CS2_SYNC_PAGE_MODE_EMUL	0	/* enable page mode emulation*/
#define CONFIG_SYS_CS2_SYNC_PAGE_SIZE		0	/* 4 words page size (8bytes) */
...
#define CONFIG_SYS_CS3_CHIP_SELECT_ENABLE	1	/* 1 : enable CS0 peripherals  */
#define CONFIG_SYS_CS3_PIN_ASSERT		0	/* chip select pin state when */
						/* chip select disabled  */
#define CONFIG_SYS_CS3_DATA_PORT_SIZE		0x5	/* 5=16 bits on D[15:0] pins */
						/* 3=8bits on D[7:0] 6=32 bits..*/
#define CONFIG_SYS_CS3_SUPERVISOR_PROTECT	0	/* 1: user mode access prohibited*/
#define CONFIG_SYS_CS3_WRITE_PROTECT		0	/* 1: write access prohibited  */
#define CONFIG_SYS_CS3_EB_SIGNAL_CONTROL_WRITE	1	/* 1 when EB is used as write signal*/
...
#define CONFIG_SYS_CS3_CS_NEG_LGTH 	30	/* max 30 ns CS HIGH to CS LOW at 100MHz */
#define CONFIG_SYS_CS3_XTRA_DEAD_CYC	0	/* ns from CS HIGH to tristate bus */
...
#define CONFIG_SYS_CS3_SYNC_ENABLE		0	/* enable synchronous burst mode*/
#define CONFIG_SYS_CS3_SYNC_PAGE_MODE_EMUL	0	/* enable page mode emulation*/
#define CONFIG_SYS_CS3_SYNC_PAGE_SIZE		0	/* 4 words page size (8bytes) */
...
#define CONFIG_SYS_CS4_CHIP_SELECT_ENABLE	1	/* 1 : enable CS0 peripherals  */
#define CONFIG_SYS_CS4_PIN_ASSERT		0	/* chip select pin state when */
						/* chip select disabled  */
#define CONFIG_SYS_CS4_DATA_PORT_SIZE		0x5	/* 5=16 bits on D[15:0] pins */
						/* 3=8bits on D[7:0] 6=32 bits..*/
#define CONFIG_SYS_CS4_SUPERVISOR_PROTECT	0	/* 1 : user mode access prohibited*/
#define CONFIG_SYS_CS4_WRITE_PROTECT		0	/* 1 : write access prohibited  */
#define CONFIG_SYS_CS4_EB_SIGNAL_CONTROL_WRITE	1	/* 1 when EB is used as write signal*/

#define CONFIG_SYS_CS4_READ_CYC_LGTH		72	/* ns */
#define CONFIG_SYS_CS4_OE_ASSERT_DLY		5	/* ns */
#define CONFIG_SYS_CS4_OE_NEG_DLY		45	/* ns */

#define CONFIG_SYS_CS4_CS_NEG_LGTH 	30	/* max 30 ns CS HIGH to CS LOW at 100MHz*/
#define CONFIG_SYS_CS4_XTRA_DEAD_CYC	0	/* ns from CS HIGH to tristate bus */
...
#define CONFIG_SYS_CS4_SYNC_ENABLE		0	/* enable synchronous burst mode*/
#define CONFIG_SYS_CS4_SYNC_PAGE_MODE_EMUL	0	/* enable page mode emulation */
#define CONFIG_SYS_CS4_SYNC_PAGE_SIZE		0	/* 4 words page size (8bytes) */
...
#define CONFIG_SYS_CS5_CHIP_SELECT_ENABLE	1	/* 1 : enable CS0 peripherals */
#define CONFIG_SYS_CS5_PIN_ASSERT		0	/* chip select pin state when */
						/* chip select disabled  */
#define CONFIG_SYS_CS5_DATA_PORT_SIZE		0x5	/* 5=16 bits on D[15:0] pins */
						/* 3=8bits on D[7:0] 6=32 bits..*/
#define CONFIG_SYS_CS5_SUPERVISOR_PROTECT	0	/* 1: user mode access prohibited*/
#define CONFIG_SYS_CS5_WRITE_PROTECT		0	/* 1 : write access prohibited*/
#define CONFIG_SYS_CS5_EB_SIGNAL_CONTROL_WRITE	1	/* 1 when EB is used as write signal*/
#define CONFIG_SYS_CS5_DTACK_SELECT		1	/* Activate DTACK fonction */
						/* (asynchrone bus) */

#define CONFIG_SYS_CS5_READ_CYC_LGTH		-1	/* ns or -1 to DTACK function */
#define CONFIG_SYS_CS5_OE_ASSERT_DLY		10	/* ns */
#define CONFIG_SYS_CS5_OE_NEG_DLY		10	/* ns */

#define CONFIG_SYS_CS5_CS_NEG_LGTH 	10	/* max 30 ns CS HIGH to CS LOW at 100MHz*/
#define CONFIG_SYS_CS5_XTRA_DEAD_CYC	0	/* ns from CS HIGH to tristate bus */
...
#define CONFIG_SYS_CS5_SYNC_ENABLE		0	/* enable synchron burst mode */
#define CONFIG_SYS_CS5_SYNC_PAGE_MODE_EMUL	0	/* enable page mode emulation */
#define CONFIG_SYS_CS5_SYNC_PAGE_SIZE		0	/* 4 words page size (8bytes) */
...
#define REG_FIELD_SCL_VAL\
	((CONFIG_SYS_SDRAM_CLOCK_CYCLE_CL_1+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)
#endif
...
#define REG_FIELD_SRCD_VAL\
	((CONFIG_SYS_SDRAM_ROW_2_COL_DELAY+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)
#endif
...
#define REG_FIELD_SRC_VAL\
	((CONFIG_SYS_SDRAM_ROW_CYCLE_DELAY+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)
#endif
...
#define CONFIG_SYS_SDRAM_MODE_REGISTER_VAL\
	...
	| (((CONFIG_SYS_SDRAM_SINGLE_ACCESS)&0x1)<<(CONFIG_SYS_SDRAM_NUM_COL+4+9)))
...
#define CONFIG_SYS_CS0U_VAL\
	((((CONFIG_SYS_CS0_XTRA_DEAD_CYC+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)\
	|((((CONFIG_SYS_CS0_WRITE_XTRA_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<4)\
	|(((((CONFIG_SYS_CS0_READ_CYC_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)-1)&0x3F)<<8)\
	|((((CONFIG_SYS_CS0_CS_NEG_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x03)<<14)\
	|((((CONFIG_SYS_CS0_SYNC_DAT_OUT_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|((CONFIG_SYS_CS0_SYNC_ENABLE&0x01)<<20)\
	|((CONFIG_SYS_CS0_SYNC_PAGE_MODE_EMUL&0x01)<<21)\
	|((CONFIG_SYS_CS0_SYNC_PAGE_SIZE&0x03)<<22)\
	|((((CONFIG_SYS_CS0_SYNC_BURST_CLK_START+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
...
#define CONFIG_SYS_CS0L_VAL\
	...
	|((((CONFIG_SYS_CS0_CS_ASSERT_NEG_DLY+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<12)\
	|(((((CONFIG_SYS_CS0_EB_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|(((((CONFIG_SYS_CS0_EB_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<20)\
	|(((((CONFIG_SYS_CS0_OE_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
	|(((((CONFIG_SYS_CS0_OE_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<28))

#define CONFIG_SYS_CS1U_VAL\
	((((CONFIG_SYS_CS1_XTRA_DEAD_CYC+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)\
	|((((CONFIG_SYS_CS1_WRITE_XTRA_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<4)\
	|(((((CONFIG_SYS_CS1_READ_CYC_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)-1)&0x3F)<<8)\
	|((((CONFIG_SYS_CS1_CS_NEG_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x03)<<14)\
	|((((CONFIG_SYS_CS1_SYNC_DAT_OUT_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|((CONFIG_SYS_CS1_SYNC_ENABLE&0x01)<<20)\
	|((CONFIG_SYS_CS1_SYNC_PAGE_MODE_EMUL&0x01)<<21)\
	|((CONFIG_SYS_CS1_SYNC_PAGE_SIZE&0x03)<<22)\
	|((((CONFIG_SYS_CS1_SYNC_BURST_CLK_START+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
...
#define CONFIG_SYS_CS1L_VAL\
	...
	|((((CONFIG_SYS_CS1_CS_ASSERT_NEG_DLY+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<12)\
	|(((((CONFIG_SYS_CS1_EB_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|(((((CONFIG_SYS_CS1_EB_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<20)\
	|(((((CONFIG_SYS_CS1_OE_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
	|(((((CONFIG_SYS_CS1_OE_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<28))

#define CONFIG_SYS_CS2U_VAL\
	(((((CONFIG_SYS_CS2_XTRA_DEAD_CYC+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)\
	|((((CONFIG_SYS_CS2_WRITE_XTRA_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<4)\
	|(((((CONFIG_SYS_CS2_READ_CYC_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)-1)&0x3F)<<8)\
	|((((CONFIG_SYS_CS2_CS_NEG_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x03)<<14)\
	|(((CONFIG_SYS_CS2_SYNC_DAT_OUT_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|((CONFIG_SYS_CS2_SYNC_ENABLE&0x01)<<20)\
	|((CONFIG_SYS_CS2_SYNC_PAGE_MODE_EMUL&0x01)<<21)\
	|((CONFIG_SYS_CS2_SYNC_PAGE_SIZE&0x03)<<22)\
	|((((CONFIG_SYS_CS2_SYNC_BURST_CLK_START+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
...
#define CONFIG_SYS_CS2L_VAL\
	...
	|((((CONFIG_SYS_CS2_CS_ASSERT_NEG_DLY+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<12)\
	|(((((CONFIG_SYS_CS2_EB_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|(((((CONFIG_SYS_CS2_EB_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<20)\
	|(((((CONFIG_SYS_CS2_OE_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
	|(((((CONFIG_SYS_CS2_OE_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<28))

#define CONFIG_SYS_CS3U_VAL\
	((((CONFIG_SYS_CS3_XTRA_DEAD_CYC+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)\
	|((((CONFIG_SYS_CS3_WRITE_XTRA_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<4)\
	|(((((CONFIG_SYS_CS3_READ_CYC_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)-1)&0x3F)<<8)\
	|((((CONFIG_SYS_CS3_CS_NEG_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x03)<<14)\
	|((((CONFIG_SYS_CS3_SYNC_DAT_OUT_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|((CONFIG_SYS_CS3_SYNC_ENABLE&0x01)<<20)\
	|((CONFIG_SYS_CS3_SYNC_PAGE_MODE_EMUL&0x01)<<21)\
	|((CONFIG_SYS_CS3_SYNC_PAGE_SIZE&0x03)<<22)\
	|((((CONFIG_SYS_CS3_SYNC_BURST_CLK_START+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
...
#define CONFIG_SYS_CS3L_VAL\
	...
	|((((CONFIG_SYS_CS3_CS_ASSERT_NEG_DLY+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<12)\
	|(((((CONFIG_SYS_CS3_EB_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|(((((CONFIG_SYS_CS3_EB_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<20)\
	|(((((CONFIG_SYS_CS3_OE_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
	|(((((CONFIG_SYS_CS3_OE_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<28))

#define CONFIG_SYS_CS4U_VAL\
	(((((CONFIG_SYS_CS4_XTRA_DEAD_CYC+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)\
	|((((CONFIG_SYS_CS4_WRITE_XTRA_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<4)\
	|(((((CONFIG_SYS_CS4_READ_CYC_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)-1)&0x3F)<<8)\
	|((((CONFIG_SYS_CS4_CS_NEG_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x03)<<14)\
	|((((CONFIG_SYS_CS4_SYNC_DAT_OUT_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16))\
	|((CONFIG_SYS_CS4_SYNC_ENABLE&0x01)<<20)\
	|((CONFIG_SYS_CS4_SYNC_PAGE_MODE_EMUL&0x01)<<21)\
	|((CONFIG_SYS_CS4_SYNC_PAGE_SIZE&0x03)<<22)\
	|((((CONFIG_SYS_CS4_SYNC_BURST_CLK_START+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
...
#define CONFIG_SYS_CS4L_VAL\
	...
	|((((CONFIG_SYS_CS4_CS_ASSERT_NEG_DLY+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<12)\
	|(((((CONFIG_SYS_CS4_EB_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|(((((CONFIG_SYS_CS4_EB_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<20)\
	|(((((CONFIG_SYS_CS4_OE_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
	|(((((CONFIG_SYS_CS4_OE_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<28))

#define CONFIG_SYS_CS5U_VAL\
	((((CONFIG_SYS_CS5_XTRA_DEAD_CYC+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)\
	|((((CONFIG_SYS_CS5_WRITE_XTRA_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<4)\
	|(((((CONFIG_SYS_CS5_READ_CYC_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)-1)&0x3F)<<8)\
	|((((CONFIG_SYS_CS5_CS_NEG_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x03)<<14)\
	|((((CONFIG_SYS_CS5_SYNC_DAT_OUT_LGTH+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|((CONFIG_SYS_CS5_SYNC_ENABLE&0x01)<<20)\
	|((CONFIG_SYS_CS5_SYNC_PAGE_MODE_EMUL&0x01)<<21)\
	|((CONFIG_SYS_CS5_SYNC_PAGE_SIZE&0x03)<<22)\
	|((((CONFIG_SYS_CS5_SYNC_BURST_CLK_START+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
...
#define CONFIG_SYS_CS5L_VAL\
	...
	|((((CONFIG_SYS_CS5_CS_ASSERT_NEG_DLY+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<12)\
	|(((((CONFIG_SYS_CS5_EB_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<16)\
	|(((((CONFIG_SYS_CS5_EB_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<20)\
	|(((((CONFIG_SYS_CS5_OE_NEG_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<24)\
	|(((((CONFIG_SYS_CS5_OE_ASSERT_DLY*2)+CONFIG_SYS_HCLK_LGTH-1)/CONFIG_SYS_HCLK_LGTH)&0x0F)<<28))
